...
## Architectural disagreement is welcome

Hyphae has explicit architectural commitments documented in the
ADR series. **Disagreement with those commitments is welcome and
expected** — file a counter-ADR with reasoning, alternatives, and
sources. The community values rigorous architectural debate.

What is not welcome: personal attacks on contributors, attempts
to wear down maintainers by re-litigating settled decisions in
issue threads, or hostility framed as architectural opinion.
Architectural disagreement is conducted in ADRs and PRs, not in
ad-hoc Slack/Discord threads or repeated GitHub issue replies.

## Enforcement Responsibilities

The project BDFL (Mario Gutiérrez) is responsible for clarifying
...
The BDFL has the right and responsibility to remove, edit, or
...
behavior may be reported to the project BDFL at
**mario@celiums.ai**. All complaints will be reviewed and
investigated promptly and fairly.

The BDFL is obligated to respect the privacy and security of the
reporter of any incident.

## Enforcement Guidelines

The BDFL will follow these Community Impact Guidelines in
...
**Consequence**: A private, written warning from the BDFL,
