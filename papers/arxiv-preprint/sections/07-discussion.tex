...
between response sentences and retrieved context; gold-answer
match measures correctness against a benchmark's reference
answer. They are complementary, not redundant. \unsupf{}
penalises hedging (Claude-4.6-Sonnet) and rewards short responses
(\hyphae{}'s template on TriviaQA). It does not measure factual
correctness against an external gold truth; that is the role of
the gold-answer column. The own-corpus result holds at
indistinguishable \unsupf{} between \hyphae{} and GPT-4.1 with
strong RAG. The TriviaQA result holds the gold-answer gap of
$\sim 4{-}16$ percentage points between \hyphae{} and oracle-mode
LLMs, and the \unsupf{} gap that derives in part from the
metric's filter mechanically catching \hyphae{}'s scaffolding
template. We report both axes alongside \unsupr{} (the raw
unfiltered NLI rate) for honesty. Readers should weigh all three.
