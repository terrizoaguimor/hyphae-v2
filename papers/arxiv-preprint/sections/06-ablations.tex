...
quotation contract (\verbpass{}, connective hygiene, quoted-content
support) holds at $1.000$ across every ablation. Of the two
head-to-head metrics, \unsupf{} moves measurably under
\textbf{A3 only}; A1, A2, and A4 produce null deltas.
(Gold-answer match is invariant across these ablations: every
condition still quotes the gold-bearing seed verbatim.)
