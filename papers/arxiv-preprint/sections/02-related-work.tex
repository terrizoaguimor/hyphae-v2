...
in a tamper-evident hash-chained journal, so the output can be
cryptographically audited back to named, unaltered sources. We
demonstrate this directly with a tamper-detection experiment
