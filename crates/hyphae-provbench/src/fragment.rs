...
const WORDS: &[&str] = &[
    "migration", "deploy", "rollback", "auditor", "indemnification",
    "clause", "latency", "percent", "quarter", "ledger", "fragment",
    "anchor", "chain", "hash", "head", "verify", "tamper", "evidence",
    "provenance", "quotation", "verbatim", "journal", "sequence",
    "signature", "key", "store", "adversary", "detection", "localised",
    "survives", "termination", "completed", "succeeded", "noted",
    "material", "findings", "grew", "rose", "UTC", "attempt",
];
